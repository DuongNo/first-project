...
public:
	...
	void ClickBtnxLdConv();
	void ClickBtnxScaraBuf();
	void ClickBtnxCellTr();
	void ClickBtnxViPre();
	void ClickBtnxStLd();
	void ClickBtnxTrayIn();
	void ClickBtnxTrayOut();

	virtual BOOL PreCreateWindow(CREATESTRUCT& cs);
	void ClickBtnxHteach1Ldrobot();
	void ClickBtnxHteach1Udrobot();
};
