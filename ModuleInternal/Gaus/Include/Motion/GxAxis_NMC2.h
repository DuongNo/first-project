...
#include "Motion\GxMotionCmd_NMC2.h"		// NMC2 API Wrapper class


class _GAUS_LIB CGxAxis_NMC2 : public CGxAxis
{
public:
	CGxAxis_NMC2(void);
	~CGxAxis_NMC2(void);
	...
	CGxMotionCmd_NMC2*	m_pMyCmd;					// 실제 동작세 사용할 Cmd : 공통에서 캐스팅 치환 시킨다.
